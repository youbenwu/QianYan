package com.qianyanhuyu.app_large.util.datastore

import android.content.Context
import androidx.datastore.core.DataStore
import androidx.datastore.preferences.core.*
import androidx.datastore.preferences.preferencesDataStore
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.clear
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.clearSync
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.getData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.getSyncData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.putData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.putSyncData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readBooleanData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readBooleanFlow
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readFloatData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readFloatFlow
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readIntData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readIntFlow
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readLongData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readLongFlow
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readStringData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.readStringFlow
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveBooleanData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveFloatData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveIntData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveLongData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveStringData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveSyncBooleanData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveSyncFloatData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveSyncIntData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveSyncLongData
import com.qianyanhuyu.app_large.util.datastore.DataStoreUtils.saveSyncStringData
...
object DataStoreUtils {
    ...
    private const val preferenceName = "AppLarge"
